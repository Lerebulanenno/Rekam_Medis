<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (empty(trim($_POST["kunjungan_id"]))) {
            $nama_err = "kunjungan harus diisi";
        } else {
            $nama = trim($_POST["kunjungan_id"]);
        }
        ...
        if (empty(trim($_POST["perawatan"]))) {
            $jenis_kelamin_err = "perawatan harus dipilih";
        } else {
    ...
    <div class="form-container">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            <div class="form-group">
                ...
                <input type="int" id="kunjungan_id" name="kunjungan" value="<?php echo $kunjungan_id; ?>">
